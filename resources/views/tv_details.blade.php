...
<html lang="en">
    <head>
        ...
        <title>CINEMA | Better Movie Better Life</title>
    </head>
    <body>
        <div class="w-full h-screen flex flex-col relative">
            ...
            @php
                ...
                $trailerID = "";
                // Cek apakah filmnya mempunyai trailer atau tidak
            ...
            <div class="w-full h-full z-10 flex flex-col justify-center px-20">
                ...
                <!-- Play Trailer -->
                {{-- if digunakan jika trailernya ada tombol muncul jika tidak ada trailer tombolnya tidak muncul --}}
                @if ($trailerID)
                <button class="w-fit bg-cinema-500 text-white pl-4 pr-6 py-3 mt-5 font-inter text-xl flex flex-row rounded-lg items-center hover:drop-shadow-lg duration-200" onclick="showTrailer(true)">
