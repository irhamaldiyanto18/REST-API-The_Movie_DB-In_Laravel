...
<html lang="en">
    ...
    <body>
        <!-- flex-col urutan dari atas ke bawah atau vertica; sedangkan flex-row dari kiri ke kanan atau horizontal -->
        <div class="w-full h-auto min-h-screen flex flex-col">
            ...
            <div class="ml-28 mt-8 flex flex-row items-center">
                <span class="font-inter text-xl font-bold">Sort</span>
            ...
            <div class="w-full pl-28 pr-10" id="loadMore">
                <button class="w-full mb-10 bg-cinema-500 text-white p-4 font-inter font-bold rounded-xl uppercase drow-shadow-lg" onclick="loadMore()">Load More</button>
            </div>
