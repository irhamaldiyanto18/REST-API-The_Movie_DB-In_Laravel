        ...
        <div class="w-full h-auto min-h-screen flex flex-col">
            ...
            <div class="w-full h-[512px] flex flex-col relative bg-black">
                ...
                <div class="flex flex-row items-center w-full h-full relative slide">
                    ...
                    <!-- Image -->
                    <img class="absolute w-full h-full object-cover" src="{{ $bannerImage }}" alt="Banner Cinema">
                    ...
                    <div class="w-10/12 flex flex-col ml-28 z-10">
                        ...
                        <span class="font-inter text-xl w-1/2 line-clamp-2 text-white">{{ $bannerItem->overview }}</span>
                        <a class="w-fit bg-cinema-500 text-white pl-2 pr-4 py-2 mt-5 font-inter text-sm flex flex-row rounded-full items-center hover:drop-shadow-lg duration-200" href="/movie/{{ $bannerItem->id }}">
                    ...
                    <a href="movie/{{ $movieID }}" class="group">
                        <div class="min-w-[232px] min-h-[428px] bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col mr-8 duration-100">
                            <div class="overflow-hidden rounded-[32px]">
                                <img class="w-full h-[300px] rounded-[32px] group-hover:scale-125 duration-200" src="{{ $movieImage }}" alt="Movies Image"/>
                            </div>
            ...
            <div>
                ...
                <div class="w-auto flex flex-row overflow-x-auto pl-28 pt-6 pb-10">
                    ...
                    <a href="tv/{{ $tvShowsID }}" class="group">
                        <div class="min-w-[232px] min-h-[428px] bg-white drop-shadow-[0_0px_8px_rgba(0,0,0,0.25)] group-hover:drop-shadow-[0_0px_8px_rgba(0,0,0,0.5)] rounded-[32px] p-5 flex flex-col mr-8 duration-100">
                            <div class="overflow-hidden rounded-[32px]">
                                <img class="w-full h-[300px] rounded-[32px] group-hover:scale-125 duration-200" src="{{ $tvShowsImage }}" alt="Top TV Shows Image"/>
                            </div>
